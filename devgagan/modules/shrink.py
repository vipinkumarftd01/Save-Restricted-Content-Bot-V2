...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://envs.sh/7m.jpg"
        join_button = InlineKeyboardButton("🪝Join Channel🪝", url="https://t.me/+A6YAcnkp67ExNWY1")
        premium = InlineKeyboardButton("💥 OWNER 💥", url="https://t.me/vipinkk798")   
